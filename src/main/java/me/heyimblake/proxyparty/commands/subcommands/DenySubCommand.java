...
@PartyAnnotationCommand(name = "rechazar", syntax = "/party rechazar <Jugador>", description = "Rechazar la party de un jugador.", requiresArgumentCompletion = true, mustBeInParty = false)
