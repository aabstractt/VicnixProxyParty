...
public class PartyDisbandListener implements Listener {
    ...
    public void onPartyDisband(PartyDisbandEvent event) {
        ...
        party.sendPartyMessage(ChatColor.AQUA + party.getLeader().getName() + ChatColor.YELLOW + " ha borrado la party!");

//        ProxyParty.getInstance().getRedis().deleteParty(event.getParty());
